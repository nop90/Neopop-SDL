...
static struct binding builtin[] = {
    ...
    { NPKS_KEY(NPKS_SH_NONE, 'y'),          NPEV_GUI_FULLSCREEN_TOGGLE },
    { NPKS_KEY(NPKS_SH_ALT , SDLK_PAUSE),  NPEV_GUI_FULLSCREEN_TOGGLE },
    { NPKS_KEY(NPKS_SH_NONE, 'l'),          NPEV_GUI_FRAMESKIP_DECREMENT },
    { NPKS_KEY(NPKS_SH_NONE, 'r'),          NPEV_GUI_FRAMESKIP_INCREMENT },
