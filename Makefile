...
TARGET		:=	neopop
BUILD		:=	build
SOURCES		:=	core core/z80 core/TLCS-900h System_SDL 
INCLUDES	:=	core core/z80 core/TLCS-900h System_SDL  
ROMFS       :=  data

APP_TITLE		:= Neopop SDL
APP_DESCRIPTION	:= NeoGeo Pocket emulator.
...
CXXFLAGS	:= $(CFLAGS) -fno-rtti -fno-exceptions -findirect-inlining
